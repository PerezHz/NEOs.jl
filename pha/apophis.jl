...
const nyears = -13.0 #39.5 #-18.0 #-18.0 #-5.0 #6.0 #21.0
...
dx_OR6_NEW = [-4.4062341665953626e-7, 1.4151959387945993e-7, 3.009771216418496e-7, 5.715492050525584e-9, -9.84044191357727e-9, -7.870189280375381e-9, 0.0] ### dx_OR6_NEW 2020Dec17.0 (TDB)
dx_OR7_NEW = [-8.072551353250423e-7, -6.977674993203065e-9, -3.535944557003007e-8, 2.3820741189757113e-9, -1.340336958871951e-8, -4.6952597219089e-9, -2.895160537809007e-14] ### dx_OR7_NEW 2020Dec17.0 (TDB)
q0 = vcat(q00, 0.0) .+ dx_OR6_NEW .+ dq # .+ dx_OR7_NEW ### .+ dq
...
# q00 = x0_JPL_s197
# q0 = vcat(q00, 0.0) .+ [7.16926378354607e-8, 1.4192184039812996e-7, 5.1865697586798626e-8, -2.321086058300051e-9, 1.3570959142237358e-9, 5.372633797102265e-10, -4.967204546715636e-14] #.+ dq
