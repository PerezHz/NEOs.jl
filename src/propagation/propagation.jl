...
@doc raw"""
    propagate(dynamics::Function, maxsteps::Int, jd0::T, tspan::T, ss16asteph_et::TaylorInterpolant,
...
@doc raw"""
    propagate_root(dynamics::Function, maxsteps::Int, jd0::T, tspan::T, ss16asteph_et::TaylorInterpolant,
...
@doc raw"""
    propagate_lyap(dynamics::Function, maxsteps::Int, jd0::T, tspan::T, ss16asteph_et::TaylorInterpolant,
...
- `parse_eqs::Bool`: whether to use the specialized method of `jetcoeffs` (`true`) or not. 
""" propagate_lyap
function propagate_lyap(dynamics::Function, maxsteps::Int, jd0::T, tspan::T, ss16asteph_et::TaylorInterpolant,
                        q0::Vector{U}; μ_ast::Vector = μ_ast343_DE430[1:end], order::Int = order,
                        abstol::T = abstol, parse_eqs::Bool = true) where {T <: Real, U <: Number}
