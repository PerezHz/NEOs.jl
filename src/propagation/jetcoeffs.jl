...
function TaylorIntegration._allocate_jetcoeffs!(::Val{RNp1BP_pN_A_J23E_J2S_ng_eph_threads!}, t::Taylor1{_T}, q::AbstractArray{Taylor1{_S}, _N}, dq::AbstractArray{Taylor1{_S}, _N}, params) where {_T <: Real, _S <: Number, _N}
    ...
    tmp687 .= Taylor1(zero(constant_term(q[1])), order)
    tmp689 = Array{Taylor1{_S}}(undef, size(ui))
    tmp689 .= Taylor1(zero(constant_term(q[1])), order)
    tmp692 = Array{Taylor1{_S}}(undef, size(dq))
    tmp692 .= Taylor1(zero(constant_term(q[1])), order)
    tmp694 = Array{Taylor1{_S}}(undef, size(vi))
    tmp694 .= Taylor1(zero(constant_term(q[1])), order)
    tmp697 = Array{Taylor1{_S}}(undef, size(dq))
    tmp697 .= Taylor1(zero(constant_term(q[1])), order)
    tmp699 = Array{Taylor1{_S}}(undef, size(wi))
    tmp699 .= Taylor1(zero(constant_term(q[1])), order)
    pn2x = Array{Taylor1{_S}}(undef, size(X))
    pn2x .= Taylor1(zero(constant_term(q[1])), order)
    pn2y = Array{Taylor1{_S}}(undef, size(Y))
    pn2y .= Taylor1(zero(constant_term(q[1])), order)
    pn2z = Array{Taylor1{_S}}(undef, size(Z))
    pn2z .= Taylor1(zero(constant_term(q[1])), order)
    tmp707 = Array{Taylor1{_S}}(undef, size(UU))
    tmp707 .= Taylor1(zero(constant_term(q[1])), order)
    tmp710 = Array{Taylor1{_S}}(undef, size(X))
    tmp710 .= Taylor1(zero(constant_term(q[1])), order)
    tmp712 = Array{Taylor1{_S}}(undef, size(Y))
    tmp712 .= Taylor1(zero(constant_term(q[1])), order)
    tmp713 = Array{Taylor1{_S}}(undef, size(tmp710))
    tmp713 .= Taylor1(zero(constant_term(q[1])), order)
    tmp715 = Array{Taylor1{_S}}(undef, size(Z))
    tmp715 .= Taylor1(zero(constant_term(q[1])), order)
    tmp723 = Array{Taylor1{_S}}(undef, size(pn2x))
    tmp723 .= Taylor1(zero(constant_term(q[1])), order)
    tmp724 = Array{Taylor1{_S}}(undef, size(tmp723))
    tmp724 .= Taylor1(zero(constant_term(q[1])), order)
    tmp819 = Array{Taylor1{_S}}(undef, size(ui))
    tmp819 .= Taylor1(zero(constant_term(q[1])), order)
    tmp821 = Array{Taylor1{_S}}(undef, size(vi))
    tmp821 .= Taylor1(zero(constant_term(q[1])), order)
    tmp822 = Array{Taylor1{_S}}(undef, size(tmp819))
    tmp822 .= Taylor1(zero(constant_term(q[1])), order)
    tmp824 = Array{Taylor1{_S}}(undef, size(wi))
    tmp824 .= Taylor1(zero(constant_term(q[1])), order)
    tmp735 = Array{Taylor1{_S}}(undef, size(X))
    tmp735 .= Taylor1(zero(constant_term(q[1])), order)
    tmp737 = Array{Taylor1{_S}}(undef, size(Y))
    tmp737 .= Taylor1(zero(constant_term(q[1])), order)
    tmp739 = Array{Taylor1{_S}}(undef, size(Z))
    tmp739 .= Taylor1(zero(constant_term(q[1])), order)
    tmp741 = Array{Taylor1{_S}}(undef, size(t31))
    tmp741 .= Taylor1(zero(constant_term(q[1])), order)
    tmp948 = Array{Taylor1{_S}}(undef, size(sin_ϕ))
    tmp948 .= Taylor1(zero(constant_term(q[1])), order)
    tmp949 = Array{Taylor1{_S}}(undef, size(ϕ))
    tmp949 .= Taylor1(zero(constant_term(q[1])), order)
    tmp751 = Array{Taylor1{_S}}(undef, size(sin2_ϕ))
    tmp751 .= Taylor1(zero(constant_term(q[1])), order)
    tmp757 = Array{Taylor1{_S}}(undef, size(sin_ϕ))
    tmp757 .= Taylor1(zero(constant_term(q[1])), order)
    tmp759 = Array{Taylor1{_S}}(undef, size(sin3_ϕ))
    tmp759 .= Taylor1(zero(constant_term(q[1])), order)
    tmp763 = Array{Taylor1{_S}}(undef, size(sin2_ϕ))
    tmp763 .= Taylor1(zero(constant_term(q[1])), order)
    tmp766 = Array{Taylor1{_S}}(undef, size(r_p2))
    tmp766 .= Taylor1(zero(constant_term(q[1])), order)
    tmp767 = Array{Taylor1{_S}}(undef, size(Λ2))
    tmp767 .= Taylor1(zero(constant_term(q[1])), order)
    tmp770 = Array{Taylor1{_S}}(undef, size(r_p1d2))
    tmp770 .= Taylor1(zero(constant_term(q[1])), order)
    tmp771 = Array{Taylor1{_S}}(undef, size(Λ3))
    tmp771 .= Taylor1(zero(constant_term(q[1])), order)
    tmp773 = Array{Taylor1{_S}}(undef, size(cos_ϕ))
    tmp773 .= Taylor1(zero(constant_term(q[1])), order)
    tmp775 = Array{Taylor1{_S}}(undef, size(cos_ϕ))
    tmp775 .= Taylor1(zero(constant_term(q[1])), order)
    tmp778 = Array{Taylor1{_S}}(undef, size(Λ2j_div_r4))
    tmp778 .= Taylor1(zero(constant_term(q[1])), order)
    tmp782 = Array{Taylor1{_S}}(undef, size(Λ3j_div_r5))
    tmp782 .= Taylor1(zero(constant_term(q[1])), order)
    tmp785 = Array{Taylor1{_S}}(undef, size(X))
    tmp785 .= Taylor1(zero(constant_term(q[1])), order)
    tmp787 = Array{Taylor1{_S}}(undef, size(Y))
    tmp787 .= Taylor1(zero(constant_term(q[1])), order)
    tmp789 = Array{Taylor1{_S}}(undef, size(Z))
    tmp789 .= Taylor1(zero(constant_term(q[1])), order)
    ...
    temp_004 .= Taylor1(zero(constant_term(q[1])), order)
    tmp835 = Array{Taylor1{_S}}(undef, size(μ))
    tmp835 .= Taylor1(zero(constant_term(q[1])), order)
    tmp837 = Array{Taylor1{_S}}(undef, size(μ))
    tmp837 .= Taylor1(zero(constant_term(q[1])), order)
    tmp839 = Array{Taylor1{_S}}(undef, size(μ))
    tmp839 .= Taylor1(zero(constant_term(q[1])), order)
    for i = 1:Nm1
    ...
    tmp845 .= Taylor1(zero(constant_term(q[1])), order)
    tmp847 = Array{Taylor1{_S}}(undef, size(vi_dot_vj))
    tmp847 .= Taylor1(zero(constant_term(q[1])), order)
    tmp848 = Array{Taylor1{_S}}(undef, size(tmp845))
    tmp848 .= Taylor1(zero(constant_term(q[1])), order)
    Xij_t_Ui = Array{Taylor1{_S}}(undef, size(X))
    Xij_t_Ui .= Taylor1(zero(constant_term(q[1])), order)
    Yij_t_Vi = Array{Taylor1{_S}}(undef, size(Y))
    Yij_t_Vi .= Taylor1(zero(constant_term(q[1])), order)
    Zij_t_Wi = Array{Taylor1{_S}}(undef, size(Z))
    Zij_t_Wi .= Taylor1(zero(constant_term(q[1])), order)
    tmp854 = Array{Taylor1{_S}}(undef, size(Xij_t_Ui))
    tmp854 .= Taylor1(zero(constant_term(q[1])), order)
    Rij_dot_Vi = Array{Taylor1{_S}}(undef, size(tmp854))
    Rij_dot_Vi .= Taylor1(zero(constant_term(q[1])), order)
    tmp857 = Array{Taylor1{_S}}(undef, size(Rij_dot_Vi))
    tmp857 .= Taylor1(zero(constant_term(q[1])), order)
    pn1t7 = Array{Taylor1{_S}}(undef, size(tmp857))
    pn1t7 .= Taylor1(zero(constant_term(q[1])), order)
    tmp860 = Array{Taylor1{_S}}(undef, size(pn1t7))
    tmp860 .= Taylor1(zero(constant_term(q[1])), order)
    pn1t2_7 = Array{Taylor1{_S}}(undef, size(ϕs_and_vs))
    pn1t2_7 .= Taylor1(zero(constant_term(q[1])), order)
    tmp867 = Array{Taylor1{_S}}(undef, size(pNX_t_X))
    tmp867 .= Taylor1(zero(constant_term(q[1])), order)
    tmp868 = Array{Taylor1{_S}}(undef, size(tmp867))
    tmp868 .= Taylor1(zero(constant_term(q[1])), order)
    tmp869 = Array{Taylor1{_S}}(undef, size(tmp868))
    tmp869 .= Taylor1(zero(constant_term(q[1])), order)
    ...
    tmp877 .= Taylor1(zero(constant_term(q[1])), order)
    termpnx = Array{Taylor1{_S}}(undef, size(X_t_pn1))
    termpnx .= Taylor1(zero(constant_term(q[1])), order)
    sumpnx = Array{Taylor1{_S}}(undef, size(termpnx))
    sumpnx .= Taylor1(zero(constant_term(q[1])), order)
    tmp880 = Array{Taylor1{_S}}(undef, size(V_t_pn2))
    tmp880 .= Taylor1(zero(constant_term(q[1])), order)
    termpny = Array{Taylor1{_S}}(undef, size(Y_t_pn1))
    termpny .= Taylor1(zero(constant_term(q[1])), order)
    sumpny = Array{Taylor1{_S}}(undef, size(termpny))
    sumpny .= Taylor1(zero(constant_term(q[1])), order)
    tmp883 = Array{Taylor1{_S}}(undef, size(W_t_pn2))
    tmp883 .= Taylor1(zero(constant_term(q[1])), order)
    termpnz = Array{Taylor1{_S}}(undef, size(Z_t_pn1))
    termpnz .= Taylor1(zero(constant_term(q[1])), order)
    sumpnz = Array{Taylor1{_S}}(undef, size(termpnz))
    sumpnz .= Taylor1(zero(constant_term(q[1])), order)
    for i = 1:10
...
function TaylorIntegration._allocate_jetcoeffs!(::Val{RNp1BP_pN_A_J23E_J2S_eph_threads!}, t::Taylor1{_T}, q::AbstractArray{Taylor1{_S}, _N}, dq::AbstractArray{Taylor1{_S}, _N}, params) where {_T <: Real, _S <: Number, _N}
    ...
    tmp1317 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1319 = Array{Taylor1{_S}}(undef, size(ui))
    tmp1319 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1322 = Array{Taylor1{_S}}(undef, size(dq))
    tmp1322 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1324 = Array{Taylor1{_S}}(undef, size(vi))
    tmp1324 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1327 = Array{Taylor1{_S}}(undef, size(dq))
    tmp1327 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1329 = Array{Taylor1{_S}}(undef, size(wi))
    tmp1329 .= Taylor1(zero(constant_term(q[1])), order)
    pn2x = Array{Taylor1{_S}}(undef, size(X))
    pn2x .= Taylor1(zero(constant_term(q[1])), order)
    pn2y = Array{Taylor1{_S}}(undef, size(Y))
    pn2y .= Taylor1(zero(constant_term(q[1])), order)
    ...
    tmp1337 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1340 = Array{Taylor1{_S}}(undef, size(X))
    tmp1340 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1342 = Array{Taylor1{_S}}(undef, size(Y))
    tmp1342 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1343 = Array{Taylor1{_S}}(undef, size(tmp1340))
    tmp1343 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1345 = Array{Taylor1{_S}}(undef, size(Z))
    tmp1345 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1353 = Array{Taylor1{_S}}(undef, size(pn2x))
    tmp1353 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1354 = Array{Taylor1{_S}}(undef, size(tmp1353))
    tmp1354 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1449 = Array{Taylor1{_S}}(undef, size(ui))
    tmp1449 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1451 = Array{Taylor1{_S}}(undef, size(vi))
    tmp1451 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1452 = Array{Taylor1{_S}}(undef, size(tmp1449))
    tmp1452 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1454 = Array{Taylor1{_S}}(undef, size(wi))
    tmp1454 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1365 = Array{Taylor1{_S}}(undef, size(X))
    tmp1365 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1367 = Array{Taylor1{_S}}(undef, size(Y))
    tmp1367 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1369 = Array{Taylor1{_S}}(undef, size(Z))
    tmp1369 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1371 = Array{Taylor1{_S}}(undef, size(t31))
    tmp1371 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1528 = Array{Taylor1{_S}}(undef, size(sin_ϕ))
    tmp1528 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1529 = Array{Taylor1{_S}}(undef, size(ϕ))
    tmp1529 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1381 = Array{Taylor1{_S}}(undef, size(sin2_ϕ))
    tmp1381 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1387 = Array{Taylor1{_S}}(undef, size(sin_ϕ))
    tmp1387 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1389 = Array{Taylor1{_S}}(undef, size(sin3_ϕ))
    tmp1389 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1393 = Array{Taylor1{_S}}(undef, size(sin2_ϕ))
    tmp1393 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1396 = Array{Taylor1{_S}}(undef, size(r_p2))
    tmp1396 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1397 = Array{Taylor1{_S}}(undef, size(Λ2))
    tmp1397 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1400 = Array{Taylor1{_S}}(undef, size(r_p1d2))
    tmp1400 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1401 = Array{Taylor1{_S}}(undef, size(Λ3))
    tmp1401 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1403 = Array{Taylor1{_S}}(undef, size(cos_ϕ))
    tmp1403 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1405 = Array{Taylor1{_S}}(undef, size(cos_ϕ))
    tmp1405 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1408 = Array{Taylor1{_S}}(undef, size(Λ2j_div_r4))
    tmp1408 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1412 = Array{Taylor1{_S}}(undef, size(Λ3j_div_r5))
    tmp1412 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1415 = Array{Taylor1{_S}}(undef, size(X))
    tmp1415 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1417 = Array{Taylor1{_S}}(undef, size(Y))
    tmp1417 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1419 = Array{Taylor1{_S}}(undef, size(Z))
    tmp1419 .= Taylor1(zero(constant_term(q[1])), order)
    #= C:\Users\luisi\.julia\dev\NEOs.jl\cosa.jl:245 =# Threads.@threads for i = 1:Nm1
            ui[i] = Taylor1(identity(constant_term(ss16asteph_t[3 * ((N - 1) + i) - 2])), order)
            vi[i] = Taylor1(identity(constant_term(ss16asteph_t[3 * ((N - 1) + i) - 1])), order)
            wi[i] = Taylor1(identity(constant_term(ss16asteph_t[3 * ((N - 1) + i)])), order)
    ...
    tmp1465 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1467 = Array{Taylor1{_S}}(undef, size(μ))
    tmp1467 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1469 = Array{Taylor1{_S}}(undef, size(μ))
    tmp1469 .= Taylor1(zero(constant_term(q[1])), order)
    for i = 1:Nm1
        temp_004[i] = Taylor1(constant_term(newtonian1b_Potential[i]) + constant_term(newtonianNb_Potential[N]), order)
        newtonianNb_Potential[N] = Taylor1(identity(constant_term(temp_004[i])), order)
        if UJ_interaction[i]
    ...
    tmp1475 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1477 = Array{Taylor1{_S}}(undef, size(vi_dot_vj))
    tmp1477 .= Taylor1(zero(constant_term(q[1])), order)
    tmp1478 = Array{Taylor1{_S}}(undef, size(tmp1475))
    tmp1478 .= Taylor1(zero(constant_term(q[1])), order)
    Xij_t_Ui = Array{Taylor1{_S}}(undef, size(X))
    Xij_t_Ui .= Taylor1(zero(constant_term(q[1])), order)
    Yij_t_Vi = Array{Taylor1{_S}}(undef, size(Y))
    Yij_t_Vi .= Taylor1(zero(constant_term(q[1])), order)
    ...
    tmp1507 .= Taylor1(zero(constant_term(q[1])), order)
    termpnx = Array{Taylor1{_S}}(undef, size(X_t_pn1))
    termpnx .= Taylor1(zero(constant_term(q[1])), order)
    sumpnx = Array{Taylor1{_S}}(undef, size(termpnx))
    sumpnx .= Taylor1(zero(constant_term(q[1])), order)
    tmp1510 = Array{Taylor1{_S}}(undef, size(V_t_pn2))
    tmp1510 .= Taylor1(zero(constant_term(q[1])), order)
    termpny = Array{Taylor1{_S}}(undef, size(Y_t_pn1))
    termpny .= Taylor1(zero(constant_term(q[1])), order)
    sumpny = Array{Taylor1{_S}}(undef, size(termpny))
    sumpny .= Taylor1(zero(constant_term(q[1])), order)
    tmp1513 = Array{Taylor1{_S}}(undef, size(W_t_pn2))
    tmp1513 .= Taylor1(zero(constant_term(q[1])), order)
    termpnz = Array{Taylor1{_S}}(undef, size(Z_t_pn1))
    termpnz .= Taylor1(zero(constant_term(q[1])), order)
    sumpnz = Array{Taylor1{_S}}(undef, size(termpnz))
    sumpnz .= Taylor1(zero(constant_term(q[1])), order)
