...
function show(io::IO, x::LOV)
    ...
    domain = x.domain
    print(io, "LOV parametrization at ", epoch, " over ", domain)
end
...
"""
function LOV(od::AbstractODProblem{D, T}, orbit::AbstractOrbit, params::Parameters{T};
             order::Int = 6, σmax::T = 5.0) where {D, T <: Real}
    # Unpack parameters
