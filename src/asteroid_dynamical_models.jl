...
function TaylorIntegration.jetcoeffs!(::Val{RNp1BP_pN_A_J23E_J2S_ng_eph!}, t::Taylor1{_T}, q::AbstractVector{Taylor1{_S}}, dq::AbstractVector{Taylor1{_S}}, params) where {_T <: Real, _S <: Number}
    order = t.order
    local ss16asteph_t = evaleph(params[1], t, q[1]) # (params[1])(t) * one(q[1])
    local acceph_t = evaleph(params[2], t, q[1]) # (params[2])(t) * one(q[1])
    local newtonianNb_Potential_t = evaleph(params[3], t, q[1]) # (params[3])(t) * one(q[1])
    local S = eltype(q[1])
    local N = length(μ)
...
#Multi-threaded version of RNp1BP_pN_A_J23E_J2S_ng_eph!
function RNp1BP_pN_A_J23E_J2S_ng_eph_threads!(dq, q, params, t)
    local ss16asteph_t = evaleph(params[1], t, q[1]) # params[1](t)*one(q[1]) #ss16asteph(t)
    local acceph_t = evaleph(params[2], t, q[1]) # params[2](t)*one(q[1]) #acc_eph(t)
    local newtonianNb_Potential_t = evaleph(params[3], t, q[1]) # params[3](t)*one(q[1]) #newtonianNb_Potential(t), massive bodies
    local S = eltype(q[1])
    local N = length(μ) # number of bodies, including NEA
...
function TaylorIntegration.jetcoeffs!(::Val{RNp1BP_pN_A_J23E_J2S_ng_eph_threads!}, t::Taylor1{_T}, q::AbstractVector{Taylor1{_S}}, dq::AbstractVector{Taylor1{_S}}, params) where {_T <: Real, _S <: Number}
    ...
    tmp1455 = Array{Taylor1{_S}}(undef, size(dq))
    tmp1455 .= Taylor1(zero(_S), order)
    tmp1458 = Array{Taylor1{_S}}(undef, size(dq))
    ...
    pn2z = Array{Taylor1{_S}}(undef, size(Z))
    pn2z .= Taylor1(zero(_S), order)
    tmp1466 = Array{Taylor1{_S}}(undef, size(UU))
    tmp1466 .= Taylor1(zero(_S), order)
    tmp1469 = Array{Taylor1{_S}}(undef, size(X))
    tmp1469 .= Taylor1(zero(_S), order)
    tmp1471 = Array{Taylor1{_S}}(undef, size(Y))
    tmp1471 .= Taylor1(zero(_S), order)
    tmp1472 = Array{Taylor1{_S}}(undef, size(tmp1469))
    tmp1472 .= Taylor1(zero(_S), order)
    tmp1474 = Array{Taylor1{_S}}(undef, size(Z))
    tmp1474 .= Taylor1(zero(_S), order)
    tmp1482 = Array{Taylor1{_S}}(undef, size(pn2x))
    tmp1482 .= Taylor1(zero(_S), order)
    tmp1483 = Array{Taylor1{_S}}(undef, size(tmp1482))
    tmp1483 .= Taylor1(zero(_S), order)
    tmp1486 = Array{Taylor1{_S}}(undef, size(X))
    tmp1486 .= Taylor1(zero(_S), order)
    tmp1488 = Array{Taylor1{_S}}(undef, size(Y))
    tmp1488 .= Taylor1(zero(_S), order)
    tmp1490 = Array{Taylor1{_S}}(undef, size(Z))
    tmp1490 .= Taylor1(zero(_S), order)
    tmp1492 = Array{Taylor1{_S}}(undef, size(t31))
    tmp1492 .= Taylor1(zero(_S), order)
    tmp1697 = Array{Taylor1{_S}}(undef, size(sin_ϕ))
    tmp1697 .= Taylor1(zero(_S), order)
    tmp1698 = Array{Taylor1{_S}}(undef, size(ϕ))
    tmp1698 .= Taylor1(zero(_S), order)
    tmp1502 = Array{Taylor1{_S}}(undef, size(sin2_ϕ))
    tmp1502 .= Taylor1(zero(_S), order)
    tmp1508 = Array{Taylor1{_S}}(undef, size(sin_ϕ))
    tmp1508 .= Taylor1(zero(_S), order)
    tmp1510 = Array{Taylor1{_S}}(undef, size(sin3_ϕ))
    tmp1510 .= Taylor1(zero(_S), order)
    tmp1514 = Array{Taylor1{_S}}(undef, size(sin2_ϕ))
    tmp1514 .= Taylor1(zero(_S), order)
    tmp1516 = Array{Taylor1{_S}}(undef, size(Λ2))
    tmp1516 .= Taylor1(zero(_S), order)
    tmp1518 = Array{Taylor1{_S}}(undef, size(r_p2))
    tmp1518 .= Taylor1(zero(_S), order)
    tmp1520 = Array{Taylor1{_S}}(undef, size(Λ3))
    tmp1520 .= Taylor1(zero(_S), order)
    tmp1522 = Array{Taylor1{_S}}(undef, size(r_p1d2))
    tmp1522 .= Taylor1(zero(_S), order)
    tmp1524 = Array{Taylor1{_S}}(undef, size(cos_ϕ))
    tmp1524 .= Taylor1(zero(_S), order)
    tmp1526 = Array{Taylor1{_S}}(undef, size(cos_ϕ))
    tmp1526 .= Taylor1(zero(_S), order)
    tmp1529 = Array{Taylor1{_S}}(undef, size(Λ2j_div_r4))
    tmp1529 .= Taylor1(zero(_S), order)
    tmp1533 = Array{Taylor1{_S}}(undef, size(Λ3j_div_r5))
    tmp1533 .= Taylor1(zero(_S), order)
    tmp1538 = Array{Taylor1{_S}}(undef, size(X))
    tmp1538 .= Taylor1(zero(_S), order)
    tmp1540 = Array{Taylor1{_S}}(undef, size(Y))
    tmp1540 .= Taylor1(zero(_S), order)
    tmp1542 = Array{Taylor1{_S}}(undef, size(Z))
    tmp1542 .= Taylor1(zero(_S), order)
    tmp1571 = Array{Taylor1{_S}}(undef, size(μ))
    tmp1571 .= Taylor1(zero(_S), order)
    tmp1573 = Array{Taylor1{_S}}(undef, size(μ))
    tmp1573 .= Taylor1(zero(_S), order)
    tmp1575 = Array{Taylor1{_S}}(undef, size(μ))
    tmp1575 .= Taylor1(zero(_S), order)
    tmp1578 = Array{Taylor1{_S}}(undef, size(ui))
    tmp1578 .= Taylor1(zero(_S), order)
    tmp1580 = Array{Taylor1{_S}}(undef, size(vi))
    tmp1580 .= Taylor1(zero(_S), order)
    tmp1581 = Array{Taylor1{_S}}(undef, size(tmp1578))
    tmp1581 .= Taylor1(zero(_S), order)
    tmp1583 = Array{Taylor1{_S}}(undef, size(wi))
    tmp1583 .= Taylor1(zero(_S), order)
    #= In[6]:220 =# Threads.@threads for i = 1:N - 1
            xi[i] = Taylor1(identity(constant_term(ss16asteph_t[3i - 2])), order)
            yi[i] = Taylor1(identity(constant_term(ss16asteph_t[3i - 1])), order)
            zi[i] = Taylor1(identity(constant_term(ss16asteph_t[3i])), order)
            ui[i] = Taylor1(identity(constant_term(ss16asteph_t[3 * ((N - 1) + i) - 2])), order)
            ...
            V[i] = Taylor1(constant_term(vi[i]) - constant_term(dq[2]), order)
            W[i] = Taylor1(constant_term(wi[i]) - constant_term(dq[3]), order)
            tmp1452[1] = Taylor1(constant_term(4) * constant_term(dq[1]), order)
            _4U_m_3X[i] = Taylor1(constant_term(tmp1452[1]) - constant_term(_3ui[i]), order)
            tmp1455[2] = Taylor1(constant_term(4) * constant_term(dq[2]), order)
            _4V_m_3Y[i] = Taylor1(constant_term(tmp1455[2]) - constant_term(_3vi[i]), order)
            tmp1458[3] = Taylor1(constant_term(4) * constant_term(dq[3]), order)
            _4W_m_3Z[i] = Taylor1(constant_term(tmp1458[3]) - constant_term(_3wi[i]), order)
            pn2x[i] = Taylor1(constant_term(X[i]) * constant_term(_4U_m_3X[i]), order)
            pn2y[i] = Taylor1(constant_term(Y[i]) * constant_term(_4V_m_3Y[i]), order)
            pn2z[i] = Taylor1(constant_term(Z[i]) * constant_term(_4W_m_3Z[i]), order)
            UU[i] = Taylor1(constant_term(ui[i]) * constant_term(dq[1]), order)
            VV[i] = Taylor1(constant_term(vi[i]) * constant_term(dq[2]), order)
            WW[i] = Taylor1(constant_term(wi[i]) * constant_term(dq[3]), order)
            tmp1466[i] = Taylor1(constant_term(UU[i]) + constant_term(VV[i]), order)
            vi_dot_vj[i] = Taylor1(constant_term(tmp1466[i]) + constant_term(WW[i]), order)
            tmp1469[i] = Taylor1(constant_term(X[i]) ^ constant_term(2), order)
            tmp1471[i] = Taylor1(constant_term(Y[i]) ^ constant_term(2), order)
            tmp1472[i] = Taylor1(constant_term(tmp1469[i]) + constant_term(tmp1471[i]), order)
            tmp1474[i] = Taylor1(constant_term(Z[i]) ^ constant_term(2), order)
            r_p2[i] = Taylor1(constant_term(tmp1472[i]) + constant_term(tmp1474[i]), order)
            r_p1d2[i] = Taylor1(sqrt(constant_term(r_p2[i])), order)
            r_p3d2[i] = Taylor1(constant_term(r_p2[i]) ^ constant_term(1.5), order)
            r_p7d2[i] = Taylor1(constant_term(r_p2[i]) ^ constant_term(3.5), order)
            newtonianCoeff[i] = Taylor1(constant_term(μ[i]) / constant_term(r_p3d2[i]), order)
            tmp1482[i] = Taylor1(constant_term(pn2x[i]) + constant_term(pn2y[i]), order)
            tmp1483[i] = Taylor1(constant_term(tmp1482[i]) + constant_term(pn2z[i]), order)
            pn2[i] = Taylor1(constant_term(newtonianCoeff[i]) * constant_term(tmp1483[i]), order)
            newtonian1b_Potential[i] = Taylor1(constant_term(μ[i]) / constant_term(r_p1d2[i]), order)
            if UJ_interaction[i]
                tmp1486[i] = Taylor1(-(constant_term(X[i])), order)
                t31[i] = Taylor1(constant_term(tmp1486[i]) * constant_term(M_[1, 3, i]), order)
                tmp1488[i] = Taylor1(-(constant_term(Y[i])), order)
                t32[i] = Taylor1(constant_term(tmp1488[i]) * constant_term(M_[2, 3, i]), order)
                tmp1490[i] = Taylor1(-(constant_term(Z[i])), order)
                t33[i] = Taylor1(constant_term(tmp1490[i]) * constant_term(M_[3, 3, i]), order)
                tmp1492[i] = Taylor1(constant_term(t31[i]) + constant_term(t32[i]), order)
                r_sin_ϕ[i] = Taylor1(constant_term(tmp1492[i]) + constant_term(t33[i]), order)
                sin_ϕ[i] = Taylor1(constant_term(r_sin_ϕ[i]) / constant_term(r_p1d2[i]), order)
                ϕ[i] = Taylor1(asin(constant_term(sin_ϕ[i])), order)
                tmp1697[i] = Taylor1(sqrt(1 - constant_term(sin_ϕ[i]) ^ 2), order)
                cos_ϕ[i] = Taylor1(cos(constant_term(ϕ[i])), order)
                tmp1698[i] = Taylor1(sin(constant_term(ϕ[i])), order)
                sin2_ϕ[i] = Taylor1(constant_term(sin_ϕ[i]) ^ constant_term(2), order)
                sin3_ϕ[i] = Taylor1(constant_term(sin_ϕ[i]) ^ constant_term(3), order)
                tmp1502[i] = Taylor1(constant_term(1.5) * constant_term(sin2_ϕ[i]), order)
                P_2_sin_ϕ[i] = Taylor1(constant_term(tmp1502[i]) - constant_term(0.5), order)
                ∂P_2_sin_ϕ[i] = Taylor1(constant_term(3) * constant_term(sin_ϕ[i]), order)
                tmp1508[i] = Taylor1(constant_term(-1.5) * constant_term(sin_ϕ[i]), order)
                tmp1510[i] = Taylor1(constant_term(2.5) * constant_term(sin3_ϕ[i]), order)
                P_3_sin_ϕ[i] = Taylor1(constant_term(tmp1508[i]) + constant_term(tmp1510[i]), order)
                tmp1514[i] = Taylor1(constant_term(7.5) * constant_term(sin2_ϕ[i]), order)
                ∂P_3_sin_ϕ[i] = Taylor1(constant_term(-1.5) + constant_term(tmp1514[i]), order)
                tmp1516[i] = Taylor1(-(constant_term(Λ2[i])), order)
                tmp1518[i] = Taylor1(constant_term(r_p2[i]) ^ constant_term(2), order)
                Λ2j_div_r4[i] = Taylor1(constant_term(tmp1516[i]) / constant_term(tmp1518[i]), order)
                tmp1520[i] = Taylor1(-(constant_term(Λ3[i])), order)
                tmp1522[i] = Taylor1(constant_term(r_p1d2[i]) ^ constant_term(5), order)
                Λ3j_div_r5[i] = Taylor1(constant_term(tmp1520[i]) / constant_term(tmp1522[i]), order)
                tmp1524[i] = Taylor1(-(constant_term(cos_ϕ[i])), order)
                m_c_ϕ_∂P_2[i] = Taylor1(constant_term(tmp1524[i]) * constant_term(∂P_2_sin_ϕ[i]), order)
                tmp1526[i] = Taylor1(-(constant_term(cos_ϕ[i])), order)
                m_c_ϕ_∂P_3[i] = Taylor1(constant_term(tmp1526[i]) * constant_term(∂P_3_sin_ϕ[i]), order)
                tmp1529[i] = Taylor1(constant_term(Λ2j_div_r4[i]) * constant_term(3), order)
                F_J2_ξ[i] = Taylor1(constant_term(tmp1529[i]) * constant_term(P_2_sin_ϕ[i]), order)
                F_J2_ζ[i] = Taylor1(constant_term(Λ2j_div_r4[i]) * constant_term(m_c_ϕ_∂P_2[i]), order)
                tmp1533[i] = Taylor1(constant_term(Λ3j_div_r5[i]) * constant_term(4), order)
                F_J3_ξ[i] = Taylor1(constant_term(tmp1533[i]) * constant_term(P_3_sin_ϕ[i]), order)
                F_J3_ζ[i] = Taylor1(constant_term(Λ3j_div_r5[i]) * constant_term(m_c_ϕ_∂P_3[i]), order)
                F_J_ξ[i] = Taylor1(constant_term(F_J2_ξ[i]) + constant_term(F_J3_ξ[i]), order)
                F_J_ζ[i] = Taylor1(constant_term(F_J2_ζ[i]) + constant_term(F_J3_ζ[i]), order)
                tmp1538[i] = Taylor1(-(constant_term(X[i])), order)
                ξx[i] = Taylor1(constant_term(tmp1538[i]) / constant_term(r_p1d2[i]), order)
                tmp1540[i] = Taylor1(-(constant_term(Y[i])), order)
                ξy[i] = Taylor1(constant_term(tmp1540[i]) / constant_term(r_p1d2[i]), order)
                tmp1542[i] = Taylor1(-(constant_term(Z[i])), order)
                ξz[i] = Taylor1(constant_term(tmp1542[i]) / constant_term(r_p1d2[i]), order)
                ηx1[i] = Taylor1(constant_term(M_[2, 3, i]) * constant_term(ξz[i]), order)
                ηy1[i] = Taylor1(constant_term(M_[3, 3, i]) * constant_term(ξx[i]), order)
                ηz1[i] = Taylor1(constant_term(M_[1, 3, i]) * constant_term(ξy[i]), order)
                ηx2[i] = Taylor1(constant_term(M_[3, 3, i]) * constant_term(ξy[i]), order)
                ...
                F_J2_y[i] = Taylor1(constant_term(F_J2_y1[i]) + constant_term(F_J2_y2[i]), order)
                F_J2_z[i] = Taylor1(constant_term(F_J2_z1[i]) + constant_term(F_J2_z2[i]), order)
                tmp1571[i] = Taylor1(constant_term(μ[i]) * constant_term(F_J2_x[i]), order)
                temp_accX_i[i] = Taylor1(-(constant_term(tmp1571[i])), order)
                tmp1573[i] = Taylor1(constant_term(μ[i]) * constant_term(F_J2_y[i]), order)
                temp_accY_i[i] = Taylor1(-(constant_term(tmp1573[i])), order)
                tmp1575[i] = Taylor1(constant_term(μ[i]) * constant_term(F_J2_z[i]), order)
                temp_accZ_i[i] = Taylor1(-(constant_term(tmp1575[i])), order)
            end
            tmp1578[i] = Taylor1(constant_term(ui[i]) ^ constant_term(2), order)
            tmp1580[i] = Taylor1(constant_term(vi[i]) ^ constant_term(2), order)
            tmp1581[i] = Taylor1(constant_term(tmp1578[i]) + constant_term(tmp1580[i]), order)
            tmp1583[i] = Taylor1(constant_term(wi[i]) ^ constant_term(2), order)
            v2[i] = Taylor1(constant_term(tmp1581[i]) + constant_term(tmp1583[i]), order)
        end
    tmp1586 = Taylor1(constant_term(q[4]) ^ constant_term(2), order)
    tmp1588 = Taylor1(constant_term(q[5]) ^ constant_term(2), order)
    tmp1589 = Taylor1(constant_term(tmp1586) + constant_term(tmp1588), order)
    tmp1591 = Taylor1(constant_term(q[6]) ^ constant_term(2), order)
    v2[N] = Taylor1(constant_term(tmp1589) + constant_term(tmp1591), order)
    for i = 1:N - 1
        newtonianNb_Potential[N] = Taylor1(constant_term(newtonianNb_Potential[N]) + constant_term(newtonian1b_Potential[i]), order)
    end
    for i = j2_body_index
    ...
    tmp1598 = Array{Taylor1{_S}}(undef, size(newtonianNb_Potential))
    tmp1598 .= Taylor1(zero(_S), order)
    temp_005a = Array{Taylor1{_S}}(undef, size(newtonianNb_Potential_t))
    temp_005a .= Taylor1(zero(_S), order)
    tmp1601 = Array{Taylor1{_S}}(undef, size(v2))
    tmp1601 .= Taylor1(zero(_S), order)
    tmp1603 = Array{Taylor1{_S}}(undef, size(vi_dot_vj))
    tmp1603 .= Taylor1(zero(_S), order)
    tmp1604 = Array{Taylor1{_S}}(undef, size(tmp1601))
    tmp1604 .= Taylor1(zero(_S), order)
    temp_005b = Array{Taylor1{_S}}(undef, size(tmp1604))
    temp_005b .= Taylor1(zero(_S), order)
    temp_005 = Array{Taylor1{_S}}(undef, size(temp_005b))
    temp_005 .= Taylor1(zero(_S), order)
    temp_006a = Array{Taylor1{_S}}(undef, size(X))
    ...
    temp_006c = Array{Taylor1{_S}}(undef, size(Z))
    temp_006c .= Taylor1(zero(_S), order)
    tmp1610 = Array{Taylor1{_S}}(undef, size(temp_006a))
    tmp1610 .= Taylor1(zero(_S), order)
    temp_006d = Array{Taylor1{_S}}(undef, size(tmp1610))
    temp_006d .= Taylor1(zero(_S), order)
    tmp1613 = Array{Taylor1{_S}}(undef, size(temp_006d))
    tmp1613 .= Taylor1(zero(_S), order)
    temp_006e = Array{Taylor1{_S}}(undef, size(tmp1613))
    temp_006e .= Taylor1(zero(_S), order)
    temp_006 = Array{Taylor1{_S}}(undef, size(temp_006e))
    temp_006 .= Taylor1(zero(_S), order)
    temp_007a = Array{Taylor1{_S}}(undef, size(X))
    ...
    temp_007c = Array{Taylor1{_S}}(undef, size(Z))
    temp_007c .= Taylor1(zero(_S), order)
    tmp1620 = Array{Taylor1{_S}}(undef, size(temp_007a))
    tmp1620 .= Taylor1(zero(_S), order)
    temp_007d = Array{Taylor1{_S}}(undef, size(tmp1620))
    temp_007d .= Taylor1(zero(_S), order)
    temp_007 = Array{Taylor1{_S}}(undef, size(temp_007d))
    temp_007 .= Taylor1(zero(_S), order)
    tmp1624 = Array{Taylor1{_S}}(undef, size(temp_005))
    tmp1624 .= Taylor1(zero(_S), order)
    temp_008 = Array{Taylor1{_S}}(undef, size(tmp1624))
    temp_008 .= Taylor1(zero(_S), order)
    tmp1626 = Array{Taylor1{_S}}(undef, size(temp_006))
    ...
    temp_013b = Array{Taylor1{_S}}(undef, size(pn3))
    temp_013b .= Taylor1(zero(_S), order)
    tmp1635 = Array{Taylor1{_S}}(undef, size(temp_013a))
    tmp1635 .= Taylor1(zero(_S), order)
    temp_014a = Array{Taylor1{_S}}(undef, size(pn2))
    temp_014a .= Taylor1(zero(_S), order)
    temp_014b = Array{Taylor1{_S}}(undef, size(pn3))
    temp_014b .= Taylor1(zero(_S), order)
    tmp1639 = Array{Taylor1{_S}}(undef, size(temp_014a))
    tmp1639 .= Taylor1(zero(_S), order)
    temp_015a = Array{Taylor1{_S}}(undef, size(pn2))
    temp_015a .= Taylor1(zero(_S), order)
    temp_015b = Array{Taylor1{_S}}(undef, size(pn3))
    temp_015b .= Taylor1(zero(_S), order)
    tmp1643 = Array{Taylor1{_S}}(undef, size(temp_015a))
    tmp1643 .= Taylor1(zero(_S), order)
    for k = Base.OneTo(succ_approx_iter)
        #= In[6]:360 =# Threads.@threads for i = 1:N - 1
                pNxi[i] = Taylor1(identity(constant_term(acceph_t[3i - 2])), order)
                pNyi[i] = Taylor1(identity(constant_term(acceph_t[3i - 1])), order)
                pNzi[i] = Taylor1(identity(constant_term(acceph_t[3i])), order)
                tmp1598[N] = Taylor1(constant_term(4) * constant_term(newtonianNb_Potential[N]), order)
                temp_005a[i] = Taylor1(constant_term(newtonianNb_Potential_t[i]) + constant_term(tmp1598[N]), order)
                tmp1601[i] = Taylor1(constant_term(2) * constant_term(v2[i]), order)
                tmp1603[i] = Taylor1(constant_term(4) * constant_term(vi_dot_vj[i]), order)
                tmp1604[i] = Taylor1(constant_term(tmp1601[i]) - constant_term(tmp1603[i]), order)
                temp_005b[i] = Taylor1(constant_term(tmp1604[i]) + constant_term(v2[N]), order)
                temp_005[i] = Taylor1(constant_term(temp_005b[i]) - constant_term(temp_005a[i]), order)
                temp_006a[i] = Taylor1(constant_term(X[i]) * constant_term(ui[i]), order)
                temp_006b[i] = Taylor1(constant_term(Y[i]) * constant_term(vi[i]), order)
                temp_006c[i] = Taylor1(constant_term(Z[i]) * constant_term(wi[i]), order)
                tmp1610[i] = Taylor1(constant_term(temp_006a[i]) + constant_term(temp_006b[i]), order)
                temp_006d[i] = Taylor1(constant_term(tmp1610[i]) + constant_term(temp_006c[i]), order)
                tmp1613[i] = Taylor1(constant_term(temp_006d[i]) ^ constant_term(2), order)
                temp_006e[i] = Taylor1(constant_term(tmp1613[i]) / constant_term(r_p2[i]), order)
                temp_006[i] = Taylor1(constant_term(1.5) * constant_term(temp_006e[i]), order)
                temp_007a[i] = Taylor1(constant_term(X[i]) * constant_term(pNxi[i]), order)
                temp_007b[i] = Taylor1(constant_term(Y[i]) * constant_term(pNyi[i]), order)
                temp_007c[i] = Taylor1(constant_term(Z[i]) * constant_term(pNzi[i]), order)
                tmp1620[i] = Taylor1(constant_term(temp_007a[i]) + constant_term(temp_007b[i]), order)
                temp_007d[i] = Taylor1(constant_term(tmp1620[i]) + constant_term(temp_007c[i]), order)
                temp_007[i] = Taylor1(constant_term(0.5) * constant_term(temp_007d[i]), order)
                tmp1624[i] = Taylor1(constant_term(temp_005[i]) + constant_term(temp_007[i]), order)
                temp_008[i] = Taylor1(constant_term(c_p2) + constant_term(tmp1624[i]), order)
                tmp1626[i] = Taylor1(constant_term(temp_006[i]) + constant_term(temp_008[i]), order)
                pn1[i] = Taylor1(constant_term(newtonianCoeff[i]) * constant_term(tmp1626[i]), order)
                temp_009[i] = Taylor1(constant_term(X[i]) * constant_term(pn1[i]), order)
                temp_010[i] = Taylor1(constant_term(Y[i]) * constant_term(pn1[i]), order)
                temp_011[i] = Taylor1(constant_term(Z[i]) * constant_term(pn1[i]), order)
                pn3[i] = Taylor1(constant_term(3.5) * constant_term(newtonian1b_Potential[i]), order)
                temp_013a[i] = Taylor1(constant_term(pn2[i]) * constant_term(U[i]), order)
                temp_013b[i] = Taylor1(constant_term(pn3[i]) * constant_term(pNxi[i]), order)
                tmp1635[i] = Taylor1(constant_term(temp_013a[i]) + constant_term(temp_013b[i]), order)
                pntempX[i] = Taylor1(constant_term(temp_009[i]) + constant_term(tmp1635[i]), order)
                temp_014a[i] = Taylor1(constant_term(pn2[i]) * constant_term(V[i]), order)
                temp_014b[i] = Taylor1(constant_term(pn3[i]) * constant_term(pNyi[i]), order)
                tmp1639[i] = Taylor1(constant_term(temp_014a[i]) + constant_term(temp_014b[i]), order)
                pntempY[i] = Taylor1(constant_term(temp_010[i]) + constant_term(tmp1639[i]), order)
                temp_015a[i] = Taylor1(constant_term(pn2[i]) * constant_term(W[i]), order)
                temp_015b[i] = Taylor1(constant_term(pn3[i]) * constant_term(pNzi[i]), order)
                tmp1643[i] = Taylor1(constant_term(temp_015a[i]) + constant_term(temp_015b[i]), order)
                pntempZ[i] = Taylor1(constant_term(temp_011[i]) + constant_term(tmp1643[i]), order)
            end
        for i = 1:N - 1
            postNewtonX = Taylor1(constant_term(postNewtonX) + constant_term(pntempX[i]), order)
            postNewtonY = Taylor1(constant_term(postNewtonY) + constant_term(pntempY[i]), order)
    ...
    tmp1651 = Taylor1(constant_term(Z[1]) * constant_term(V[1]), order)
    tmp1652 = Taylor1(constant_term(Y[1]) * constant_term(W[1]), order)
    hx = Taylor1(constant_term(tmp1651) - constant_term(tmp1652), order)
    tmp1654 = Taylor1(constant_term(X[1]) * constant_term(W[1]), order)
    tmp1655 = Taylor1(constant_term(Z[1]) * constant_term(U[1]), order)
    hy = Taylor1(constant_term(tmp1654) - constant_term(tmp1655), order)
    tmp1657 = Taylor1(constant_term(Y[1]) * constant_term(U[1]), order)
    tmp1658 = Taylor1(constant_term(X[1]) * constant_term(V[1]), order)
    hz = Taylor1(constant_term(tmp1657) - constant_term(tmp1658), order)
    r_hs = Taylor1(sqrt(constant_term(r_p2[1])), order)
    runitx = Taylor1(constant_term(X[1]) / constant_term(r_hs), order)
    runity = Taylor1(constant_term(Y[2]) / constant_term(r_hs), order)
    runitz = Taylor1(constant_term(Z[3]) / constant_term(r_hs), order)
    tmp1664 = Taylor1(constant_term(hy) * constant_term(runitz), order)
    tmp1665 = Taylor1(constant_term(hz) * constant_term(runity), order)
    tunitx0 = Taylor1(constant_term(tmp1664) - constant_term(tmp1665), order)
    tmp1667 = Taylor1(constant_term(hz) * constant_term(runitx), order)
    tmp1668 = Taylor1(constant_term(hx) * constant_term(runitz), order)
    tunity0 = Taylor1(constant_term(tmp1667) - constant_term(tmp1668), order)
    tmp1670 = Taylor1(constant_term(hx) * constant_term(runity), order)
    tmp1671 = Taylor1(constant_term(hy) * constant_term(runitx), order)
    tunitz0 = Taylor1(constant_term(tmp1670) - constant_term(tmp1671), order)
    tmp1674 = Taylor1(constant_term(tunitx0) ^ constant_term(2), order)
    tmp1676 = Taylor1(constant_term(tunity0) ^ constant_term(2), order)
    tmp1677 = Taylor1(constant_term(tmp1674) + constant_term(tmp1676), order)
    tmp1679 = Taylor1(constant_term(tunitz0) ^ constant_term(2), order)
    tmp1680 = Taylor1(constant_term(tmp1677) + constant_term(tmp1679), order)
    hmag = Taylor1(sqrt(constant_term(tmp1680)), order)
    tunitx = Taylor1(constant_term(tunitx0) / constant_term(hmag), order)
    tunity = Taylor1(constant_term(tunity0) / constant_term(hmag), order)
    tunitz = Taylor1(constant_term(tunitz0) / constant_term(hmag), order)
    g_r = Taylor1(constant_term(r_hs) ^ constant_term(-2.0), order)
    ...
    NGAy = Taylor1(constant_term(A2_t_g_r) * constant_term(tunity), order)
    NGAz = Taylor1(constant_term(A2_t_g_r) * constant_term(tunitz), order)
    tmp1691 = Taylor1(constant_term(postNewtonX) + constant_term(accX), order)
    dq[4] = Taylor1(constant_term(tmp1691) + constant_term(NGAx), order)
    tmp1693 = Taylor1(constant_term(postNewtonY) + constant_term(accY), order)
    dq[5] = Taylor1(constant_term(tmp1693) + constant_term(NGAy), order)
    tmp1695 = Taylor1(constant_term(postNewtonZ) + constant_term(accZ), order)
    dq[6] = Taylor1(constant_term(tmp1695) + constant_term(NGAz), order)
    dq[7] = Taylor1(identity(constant_term(zero_q_1)), order)
    for __idx = eachindex(q)
        (q[__idx]).coeffs[2] = (dq[__idx]).coeffs[1]
    end
    for ord = 1:order - 1
        ...
        #= In[6]:220 =# Threads.@threads for i = 1:N - 1
                ...
                TaylorSeries.subst!(V[i], vi[i], dq[2], ord)
                TaylorSeries.subst!(W[i], wi[i], dq[3], ord)
                TaylorSeries.mul!(tmp1452[1], 4, dq[1], ord)
                TaylorSeries.subst!(_4U_m_3X[i], tmp1452[1], _3ui[i], ord)
                TaylorSeries.mul!(tmp1455[2], 4, dq[2], ord)
                TaylorSeries.subst!(_4V_m_3Y[i], tmp1455[2], _3vi[i], ord)
                TaylorSeries.mul!(tmp1458[3], 4, dq[3], ord)
                TaylorSeries.subst!(_4W_m_3Z[i], tmp1458[3], _3wi[i], ord)
                TaylorSeries.mul!(pn2x[i], X[i], _4U_m_3X[i], ord)
                TaylorSeries.mul!(pn2y[i], Y[i], _4V_m_3Y[i], ord)
                TaylorSeries.mul!(pn2z[i], Z[i], _4W_m_3Z[i], ord)
                TaylorSeries.mul!(UU[i], ui[i], dq[1], ord)
                TaylorSeries.mul!(VV[i], vi[i], dq[2], ord)
                TaylorSeries.mul!(WW[i], wi[i], dq[3], ord)
                TaylorSeries.add!(tmp1466[i], UU[i], VV[i], ord)
                TaylorSeries.add!(vi_dot_vj[i], tmp1466[i], WW[i], ord)
                TaylorSeries.pow!(tmp1469[i], X[i], 2, ord)
                TaylorSeries.pow!(tmp1471[i], Y[i], 2, ord)
                TaylorSeries.add!(tmp1472[i], tmp1469[i], tmp1471[i], ord)
                TaylorSeries.pow!(tmp1474[i], Z[i], 2, ord)
                TaylorSeries.add!(r_p2[i], tmp1472[i], tmp1474[i], ord)
                TaylorSeries.sqrt!(r_p1d2[i], r_p2[i], ord)
                TaylorSeries.pow!(r_p3d2[i], r_p2[i], 1.5, ord)
                TaylorSeries.pow!(r_p7d2[i], r_p2[i], 3.5, ord)
                TaylorSeries.div!(newtonianCoeff[i], μ[i], r_p3d2[i], ord)
                TaylorSeries.add!(tmp1482[i], pn2x[i], pn2y[i], ord)
                TaylorSeries.add!(tmp1483[i], tmp1482[i], pn2z[i], ord)
                TaylorSeries.mul!(pn2[i], newtonianCoeff[i], tmp1483[i], ord)
                TaylorSeries.div!(newtonian1b_Potential[i], μ[i], r_p1d2[i], ord)
                if UJ_interaction[i]
                    TaylorSeries.subst!(tmp1486[i], X[i], ord)
                    TaylorSeries.mul!(t31[i], tmp1486[i], M_[1, 3, i], ord)
                    TaylorSeries.subst!(tmp1488[i], Y[i], ord)
                    TaylorSeries.mul!(t32[i], tmp1488[i], M_[2, 3, i], ord)
                    TaylorSeries.subst!(tmp1490[i], Z[i], ord)
                    TaylorSeries.mul!(t33[i], tmp1490[i], M_[3, 3, i], ord)
                    TaylorSeries.add!(tmp1492[i], t31[i], t32[i], ord)
                    TaylorSeries.add!(r_sin_ϕ[i], tmp1492[i], t33[i], ord)
                    TaylorSeries.div!(sin_ϕ[i], r_sin_ϕ[i], r_p1d2[i], ord)
                    TaylorSeries.asin!(ϕ[i], sin_ϕ[i], tmp1697[i], ord)
                    TaylorSeries.sincos!(tmp1698[i], cos_ϕ[i], ϕ[i], ord)
                    TaylorSeries.pow!(sin2_ϕ[i], sin_ϕ[i], 2, ord)
                    TaylorSeries.pow!(sin3_ϕ[i], sin_ϕ[i], 3, ord)
                    TaylorSeries.mul!(tmp1502[i], 1.5, sin2_ϕ[i], ord)
                    TaylorSeries.subst!(P_2_sin_ϕ[i], tmp1502[i], 0.5, ord)
                    TaylorSeries.mul!(∂P_2_sin_ϕ[i], 3, sin_ϕ[i], ord)
                    TaylorSeries.mul!(tmp1508[i], -1.5, sin_ϕ[i], ord)
                    TaylorSeries.mul!(tmp1510[i], 2.5, sin3_ϕ[i], ord)
                    TaylorSeries.add!(P_3_sin_ϕ[i], tmp1508[i], tmp1510[i], ord)
                    TaylorSeries.mul!(tmp1514[i], 7.5, sin2_ϕ[i], ord)
                    TaylorSeries.add!(∂P_3_sin_ϕ[i], -1.5, tmp1514[i], ord)
                    TaylorSeries.subst!(tmp1516[i], Λ2[i], ord)
                    TaylorSeries.pow!(tmp1518[i], r_p2[i], 2, ord)
                    TaylorSeries.div!(Λ2j_div_r4[i], tmp1516[i], tmp1518[i], ord)
                    TaylorSeries.subst!(tmp1520[i], Λ3[i], ord)
                    TaylorSeries.pow!(tmp1522[i], r_p1d2[i], 5, ord)
                    TaylorSeries.div!(Λ3j_div_r5[i], tmp1520[i], tmp1522[i], ord)
                    TaylorSeries.subst!(tmp1524[i], cos_ϕ[i], ord)
                    TaylorSeries.mul!(m_c_ϕ_∂P_2[i], tmp1524[i], ∂P_2_sin_ϕ[i], ord)
                    TaylorSeries.subst!(tmp1526[i], cos_ϕ[i], ord)
                    TaylorSeries.mul!(m_c_ϕ_∂P_3[i], tmp1526[i], ∂P_3_sin_ϕ[i], ord)
                    TaylorSeries.mul!(tmp1529[i], Λ2j_div_r4[i], 3, ord)
                    TaylorSeries.mul!(F_J2_ξ[i], tmp1529[i], P_2_sin_ϕ[i], ord)
                    TaylorSeries.mul!(F_J2_ζ[i], Λ2j_div_r4[i], m_c_ϕ_∂P_2[i], ord)
                    TaylorSeries.mul!(tmp1533[i], Λ3j_div_r5[i], 4, ord)
                    TaylorSeries.mul!(F_J3_ξ[i], tmp1533[i], P_3_sin_ϕ[i], ord)
                    TaylorSeries.mul!(F_J3_ζ[i], Λ3j_div_r5[i], m_c_ϕ_∂P_3[i], ord)
                    TaylorSeries.add!(F_J_ξ[i], F_J2_ξ[i], F_J3_ξ[i], ord)
                    TaylorSeries.add!(F_J_ζ[i], F_J2_ζ[i], F_J3_ζ[i], ord)
                    TaylorSeries.subst!(tmp1538[i], X[i], ord)
                    TaylorSeries.div!(ξx[i], tmp1538[i], r_p1d2[i], ord)
                    TaylorSeries.subst!(tmp1540[i], Y[i], ord)
                    TaylorSeries.div!(ξy[i], tmp1540[i], r_p1d2[i], ord)
                    TaylorSeries.subst!(tmp1542[i], Z[i], ord)
                    TaylorSeries.div!(ξz[i], tmp1542[i], r_p1d2[i], ord)
                    TaylorSeries.mul!(ηx1[i], M_[2, 3, i], ξz[i], ord)
                    TaylorSeries.mul!(ηy1[i], M_[3, 3, i], ξx[i], ord)
                    TaylorSeries.mul!(ηz1[i], M_[1, 3, i], ξy[i], ord)
                    TaylorSeries.mul!(ηx2[i], M_[3, 3, i], ξy[i], ord)
                    ...
                    TaylorSeries.add!(F_J2_y[i], F_J2_y1[i], F_J2_y2[i], ord)
                    TaylorSeries.add!(F_J2_z[i], F_J2_z1[i], F_J2_z2[i], ord)
                    TaylorSeries.mul!(tmp1571[i], μ[i], F_J2_x[i], ord)
                    TaylorSeries.subst!(temp_accX_i[i], tmp1571[i], ord)
                    TaylorSeries.mul!(tmp1573[i], μ[i], F_J2_y[i], ord)
                    TaylorSeries.subst!(temp_accY_i[i], tmp1573[i], ord)
                    TaylorSeries.mul!(tmp1575[i], μ[i], F_J2_z[i], ord)
                    TaylorSeries.subst!(temp_accZ_i[i], tmp1575[i], ord)
                end
                TaylorSeries.pow!(tmp1578[i], ui[i], 2, ord)
                TaylorSeries.pow!(tmp1580[i], vi[i], 2, ord)
                TaylorSeries.add!(tmp1581[i], tmp1578[i], tmp1580[i], ord)
                TaylorSeries.pow!(tmp1583[i], wi[i], 2, ord)
                TaylorSeries.add!(v2[i], tmp1581[i], tmp1583[i], ord)
            end
        TaylorSeries.pow!(tmp1586, q[4], 2, ord)
        TaylorSeries.pow!(tmp1588, q[5], 2, ord)
        TaylorSeries.add!(tmp1589, tmp1586, tmp1588, ord)
        TaylorSeries.pow!(tmp1591, q[6], 2, ord)
        TaylorSeries.add!(v2[N], tmp1589, tmp1591, ord)
        for i = 1:N - 1
            TaylorSeries.add!(newtonianNb_Potential[N], newtonianNb_Potential[N], newtonian1b_Potential[i], ord)
        end
        for i = j2_body_index
        ...
        for k = Base.OneTo(succ_approx_iter)
            #= In[6]:360 =# Threads.@threads for i = 1:N - 1
                    ...
                    TaylorSeries.identity!(pNyi[i], acceph_t[3i - 1], ord)
                    TaylorSeries.identity!(pNzi[i], acceph_t[3i], ord)
                    TaylorSeries.mul!(tmp1598[N], 4, newtonianNb_Potential[N], ord)
                    TaylorSeries.add!(temp_005a[i], newtonianNb_Potential_t[i], tmp1598[N], ord)
                    TaylorSeries.mul!(tmp1601[i], 2, v2[i], ord)
                    TaylorSeries.mul!(tmp1603[i], 4, vi_dot_vj[i], ord)
                    TaylorSeries.subst!(tmp1604[i], tmp1601[i], tmp1603[i], ord)
                    TaylorSeries.add!(temp_005b[i], tmp1604[i], v2[N], ord)
                    TaylorSeries.subst!(temp_005[i], temp_005b[i], temp_005a[i], ord)
                    TaylorSeries.mul!(temp_006a[i], X[i], ui[i], ord)
                    TaylorSeries.mul!(temp_006b[i], Y[i], vi[i], ord)
                    TaylorSeries.mul!(temp_006c[i], Z[i], wi[i], ord)
                    TaylorSeries.add!(tmp1610[i], temp_006a[i], temp_006b[i], ord)
                    TaylorSeries.add!(temp_006d[i], tmp1610[i], temp_006c[i], ord)
                    TaylorSeries.pow!(tmp1613[i], temp_006d[i], 2, ord)
                    TaylorSeries.div!(temp_006e[i], tmp1613[i], r_p2[i], ord)
                    TaylorSeries.mul!(temp_006[i], 1.5, temp_006e[i], ord)
                    TaylorSeries.mul!(temp_007a[i], X[i], pNxi[i], ord)
                    TaylorSeries.mul!(temp_007b[i], Y[i], pNyi[i], ord)
                    TaylorSeries.mul!(temp_007c[i], Z[i], pNzi[i], ord)
                    TaylorSeries.add!(tmp1620[i], temp_007a[i], temp_007b[i], ord)
                    TaylorSeries.add!(temp_007d[i], tmp1620[i], temp_007c[i], ord)
                    TaylorSeries.mul!(temp_007[i], 0.5, temp_007d[i], ord)
                    TaylorSeries.add!(tmp1624[i], temp_005[i], temp_007[i], ord)
                    TaylorSeries.add!(temp_008[i], c_p2, tmp1624[i], ord)
                    TaylorSeries.add!(tmp1626[i], temp_006[i], temp_008[i], ord)
                    TaylorSeries.mul!(pn1[i], newtonianCoeff[i], tmp1626[i], ord)
                    TaylorSeries.mul!(temp_009[i], X[i], pn1[i], ord)
                    TaylorSeries.mul!(temp_010[i], Y[i], pn1[i], ord)
                    TaylorSeries.mul!(temp_011[i], Z[i], pn1[i], ord)
                    TaylorSeries.mul!(pn3[i], 3.5, newtonian1b_Potential[i], ord)
                    TaylorSeries.mul!(temp_013a[i], pn2[i], U[i], ord)
                    TaylorSeries.mul!(temp_013b[i], pn3[i], pNxi[i], ord)
                    TaylorSeries.add!(tmp1635[i], temp_013a[i], temp_013b[i], ord)
                    TaylorSeries.add!(pntempX[i], temp_009[i], tmp1635[i], ord)
                    TaylorSeries.mul!(temp_014a[i], pn2[i], V[i], ord)
                    TaylorSeries.mul!(temp_014b[i], pn3[i], pNyi[i], ord)
                    TaylorSeries.add!(tmp1639[i], temp_014a[i], temp_014b[i], ord)
                    TaylorSeries.add!(pntempY[i], temp_010[i], tmp1639[i], ord)
                    TaylorSeries.mul!(temp_015a[i], pn2[i], W[i], ord)
                    TaylorSeries.mul!(temp_015b[i], pn3[i], pNzi[i], ord)
                    TaylorSeries.add!(tmp1643[i], temp_015a[i], temp_015b[i], ord)
                    TaylorSeries.add!(pntempZ[i], temp_011[i], tmp1643[i], ord)
                end
            for i = 1:N - 1
                TaylorSeries.add!(postNewtonX, postNewtonX, pntempX[i], ord)
                TaylorSeries.add!(postNewtonY, postNewtonY, pntempY[i], ord)
        ...
        TaylorSeries.mul!(tmp1651, Z[1], V[1], ord)
        TaylorSeries.mul!(tmp1652, Y[1], W[1], ord)
        TaylorSeries.subst!(hx, tmp1651, tmp1652, ord)
        TaylorSeries.mul!(tmp1654, X[1], W[1], ord)
        TaylorSeries.mul!(tmp1655, Z[1], U[1], ord)
        TaylorSeries.subst!(hy, tmp1654, tmp1655, ord)
        TaylorSeries.mul!(tmp1657, Y[1], U[1], ord)
        TaylorSeries.mul!(tmp1658, X[1], V[1], ord)
        TaylorSeries.subst!(hz, tmp1657, tmp1658, ord)
        TaylorSeries.sqrt!(r_hs, r_p2[1], ord)
        TaylorSeries.div!(runitx, X[1], r_hs, ord)
        TaylorSeries.div!(runity, Y[2], r_hs, ord)
        TaylorSeries.div!(runitz, Z[3], r_hs, ord)
        TaylorSeries.mul!(tmp1664, hy, runitz, ord)
        TaylorSeries.mul!(tmp1665, hz, runity, ord)
        TaylorSeries.subst!(tunitx0, tmp1664, tmp1665, ord)
        TaylorSeries.mul!(tmp1667, hz, runitx, ord)
        TaylorSeries.mul!(tmp1668, hx, runitz, ord)
        TaylorSeries.subst!(tunity0, tmp1667, tmp1668, ord)
        TaylorSeries.mul!(tmp1670, hx, runity, ord)
        TaylorSeries.mul!(tmp1671, hy, runitx, ord)
        TaylorSeries.subst!(tunitz0, tmp1670, tmp1671, ord)
        TaylorSeries.pow!(tmp1674, tunitx0, 2, ord)
        TaylorSeries.pow!(tmp1676, tunity0, 2, ord)
        TaylorSeries.add!(tmp1677, tmp1674, tmp1676, ord)
        TaylorSeries.pow!(tmp1679, tunitz0, 2, ord)
        TaylorSeries.add!(tmp1680, tmp1677, tmp1679, ord)
        TaylorSeries.sqrt!(hmag, tmp1680, ord)
        TaylorSeries.div!(tunitx, tunitx0, hmag, ord)
        TaylorSeries.div!(tunity, tunity0, hmag, ord)
        TaylorSeries.div!(tunitz, tunitz0, hmag, ord)
        TaylorSeries.pow!(g_r, r_hs, -2.0, ord)
        ...
        TaylorSeries.mul!(NGAy, A2_t_g_r, tunity, ord)
        TaylorSeries.mul!(NGAz, A2_t_g_r, tunitz, ord)
        TaylorSeries.add!(tmp1691, postNewtonX, accX, ord)
        TaylorSeries.add!(dq[4], tmp1691, NGAx, ord)
        TaylorSeries.add!(tmp1693, postNewtonY, accY, ord)
        TaylorSeries.add!(dq[5], tmp1693, NGAy, ord)
        TaylorSeries.add!(tmp1695, postNewtonZ, accZ, ord)
        TaylorSeries.add!(dq[6], tmp1695, NGAz, ord)
        TaylorSeries.identity!(dq[7], zero_q_1, ord)
        for __idx = eachindex(q)
            (q[__idx]).coeffs[ordnext + 1] = (dq[__idx]).coeffs[ordnext] / ordnext
        end
