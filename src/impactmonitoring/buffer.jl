...
- `g_dg_val::Vector{U}`, `evalaux::U`, `g_dg::Vector{Taylor1{U}}` and
    `g_constant::Vector{Taylor1{T}}`: [`findroot`](@ref) buffer.
...
function ImpactMonitoringBuffer(IM::AbstractIMProblem{D, T}, q0::Vector{U}, nyears::T,
    ...
    root = RootFindingBuffer{T, U}(jd0, rv, teph, g_dg_val, evalaux, g_dg, g_constant,
